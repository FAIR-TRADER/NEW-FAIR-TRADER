...
window.addEventListener("load", () => {
  const animatedElements = document.querySelectorAll(".principle-card, .stat-item")
...
document.addEventListener("keydown", (event) => {
  ...
  // Enter 키로 원칙 카드 토글
  if (event.key === "Enter" && event.target.classList.contains("principle-card")) {
